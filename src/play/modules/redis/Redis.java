...
public class Redis {
    ...
    public static java.lang.Long linsert(byte[] key, redis.clients.jedis.BinaryClient.LIST_POSITION where, byte[] pivot,
                                         byte[] value) {
        Jedis jedis = RedisConnectionManager.getRawConnectionFromShard(key);
        return jedis.linsert(key, where, pivot, value);
    }

    public static java.lang.Long linsert(java.lang.String key, redis.clients.jedis.BinaryClient.LIST_POSITION where,
    ...
    public static java.lang.Long sort(java.lang.String key, redis.clients.jedis.SortingParams sortingParameters,
    ...
    public static java.lang.Long zinterstore(java.lang.String dstkey, redis.clients.jedis.ZParams params,
    ...
    public static java.util.Set zrangeByScoreWithScores(java.lang.String key, double min, double max, int offset,
                                                        int count) {
        Jedis jedis = RedisConnectionManager.getRawConnectionFromShard(key);
    ...
    public static java.util.Set zrevrangeByScoreWithScores(java.lang.String key, double max, double min, int offset,
                                                           int count) {
        Jedis jedis = RedisConnectionManager.getRawConnectionFromShard(key);
    ...
    public static java.lang.Long zunionstore(java.lang.String dstkey, redis.clients.jedis.ZParams params,
                                             java.lang.String[] sets) {
        if(!RedisConnectionManager.isSharded()) {
            Jedis jedis = RedisConnectionManager.getRawConnectionInternal();
